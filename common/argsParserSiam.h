...
struct SampleParams
{
    ...
    std::vector<std::string> inputTensorNamesTemplate;
    std::vector<std::string> outputTensorNamesTemplate;
    std::vector<std::string> inputTensorNamesTrack;
    std::vector<std::string> outputTensorNamesTrack;
};
...
{
    std::string onnxFileNameTemplate; //!< Filename of ONNX Template file of a network
    std::string onnxFileNameTrack; //!< Filename of ONNX Track file of a network
};

//!
//! \brief The TrtParams structure groups the additional parameters required by
//!         networks that use ONNX
//!
struct TrtParams : public SampleParams
{
    char *TrtFileTemplate; //!< Filename of ONNX Template file of a network
    char *TrtFileTrack; //!< Filename of ONNX Track file of a network
};
